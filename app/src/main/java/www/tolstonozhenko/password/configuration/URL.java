...
public class URL {
    static public String HTPP_URL = "http://odz.tolstonozhenko.com.ua/";
    static public String HTPP_URL_LOGIN = HTPP_URL + "/api/auth/signin";
    static public String HTPP_URL_REGISTER = HTPP_URL + "/api/auth/signup";
    ...
    static public String HTPP_QR_RESPONSE = HTPP_URL + "/qr/returnResponse";
}
